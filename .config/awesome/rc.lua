...
awful.spawn.single_instance("libinput-gestures-setup start")
...
for _, t in ipairs({{"p", 10, "🎻"}, {"bracketleft", 11, "🦊"}, {"bracketright", 12, "🧿"}}) do
    local key = t[1]
    local tagnum = t[2]
    local icon = t[3]
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey }, key,
                  ...
                  {description = "view tag "..icon, group = "tag"}),
        -- Toggle tag display.
        awful.key({ modkey, "Control" }, key,
                  ...
                  {description = "toggle tag " .. icon, group = "tag"}),
        -- Move client to tag.
        awful.key({ modkey, "Shift" }, key,
                  ...
                  {description = "move focused client to tag "..icon, group = "tag"}),
        -- Toggle tag on focused client.
        awful.key({ modkey, "Control", "Shift" }, key,
                  ...
                  {description = "toggle focused client on tag " .. icon, group = "tag"})
    )
end
