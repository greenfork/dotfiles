...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            delimiter,
            awful.widget.watch(scripts .. "/memory_free.sh", 5),
            delimiter,
            awful.widget.watch(scripts .. "/uptime.sh", 5),
            delimiter,
            awful.widget.watch(scripts .. "/temp_lmsensors.sh", 15),
            delimiter,
            awful.widget.watch(scripts .. "/sound_amixer.sh", 5),
            wibox.widget.textbox(" ♪"),
            delimiter,
            wibox.widget.textclock("%a %H:%M | %d.%m.%Y"),
            delimiter,
            awful.widget.watch(scripts .. "/battery_acpi.sh", 15),
            delimiter,
